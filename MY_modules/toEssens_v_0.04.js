...
;(function () {
        ...
        FNc['Array'] = function (A) {
            ...
            A.New = {
                ...
                _$new_arr_from_like_arr_(like_arr) {
                    return Array.from(like_arr);
                },
                _$new_arr_of_args_(any_elem_1, any_elem_n) {
                    return Array.of(any_elem_1, any_elem_n)
                },
                _$new_arr_from_str_(str) {
                    return str.split('');
                },
                _$new_arr_from_obj_(obj) {
        ...
        FNc['String'] = function (A) {
            ...
            A.Meth = {
                ...
                _$map_for_str(callback, thisArg) {
                    let A_Self = A.Self;
                    let arr = A_Self.split('').map(callback, thisArg);
                    return arr.join('');
                }
            };
        ...
        FNc['Object'] = function (A) {
            ...
            A.New = {
                _$new_obj_from_str_with_map_(str, callback, thisArg) {
                ...
                _$new_obj_from_arr_with_map_(arr, callback, thisArg) {
                    let iter = arr.map(callback, thisArg).entries();
                    let o = {};
                    for (const iterElement of iter) {
                        o[iterElement[0]] = iterElement[1];
                    }
                ...
                _$new_obj_from_entries_() {
                    return new Object.fromEntries(A.Self);
                },
            ...
            A.Meth = {
                ...
                _$create_NewWithprotoFromIntObj_(init_props) {
                ...
                _$defineProperties_Value_(props_value) { // {props : value}
                    let pr = props_value.props;
                    let val = props_value.value;
                    return Object.defineProperties(A.Self, {
                        pr: {
                            value: val,
                            writable: false,
                            configurable: false,
                ...
                _$defineProperties_Value_Wr_(props_value) { // {props : value}
                    let pr = props_value.props;
                    let val = props_value.value;
                    return Object.defineProperties(A.Self, {
                        pr: {
                ...
                _$defineProperties_Value_WrConf_(props_value) { // {props : value}
                    let pr = props_value.props;
                    let val = props_value.value;
                    return Object.defineProperties(A.Self, {
                        pr: {
                ...
                _$defineProperties_GetSet_(get_set) { // {prop : name_prop ,get : get_call, set : set_cali}
                    let get_call = get_set.get;
                    let set_cali = get_set.set;
                    let name_prop = get_set.prop;
                    return Object.defineProperties(A.Self, {
                        name_prop: {
                            get: get_call,
                            set: set_cali,
                ...
                _$map_for_obj_(callback, thisArg) {
                    let entr = Object.entries(A.Self).map(callback, thisArg);
                    return Object.fromEntries(entr);
                },
                _$freeze_() {
                    Object.freeze(A.Self);
                    return A.Self;
                },
                _$getOwnPropertyDescriptor_(prop) {
                    let A_Self = A.Self
                    if (A_Self.hasOwnProperty(prop)) {
                        return Object.getOwnPropertyDescriptor(A_Self, prop);
                    } else {
                        return false;
                    }
                },
