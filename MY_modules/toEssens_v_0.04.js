...
;(function () {
    ...
    FNc['Object'] = function (A) {
      ...
      A.Meth = {
        ...
        _$defineProperties_Value(props_value) { // {props : value}
        ...
        _$defineProperties_Value_Wr(props_value) { // {props : value}
          let pr = props_value.props;
          let val = props_value.value;
          return Object.defineProperties(A.Self, {
            pr: {
        ...
        _$defineProperties_Value_WrConf(props_value) { // {props : value}
          let pr = props_value.props;
          let val = props_value.value;
          return Object.defineProperties(A.Self, {
            pr: {
        ...
        _$defineProperties_GetSet(get_set) { // {prop : name_prop ,get : get_call, set : set_cali}
